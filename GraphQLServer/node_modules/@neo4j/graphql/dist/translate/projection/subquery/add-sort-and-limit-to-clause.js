...
function addSortAndLimitOptionsToClause({ optionsInput, target, projectionClause, nodeField, fulltextScoreVariable, cypherFields, cypherFieldAliasMap, }) {
...
function createOrderByParams({ optionsInput, target, nodeField, fulltextScoreVariable, cypherFields, cypherFieldAliasMap, }) {
