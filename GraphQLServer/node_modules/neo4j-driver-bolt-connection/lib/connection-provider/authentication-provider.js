...
var AuthenticationProvider = /** @class */ (function () {
    function AuthenticationProvider(_a) {
        var authTokenManager = _a.authTokenManager, userAgent = _a.userAgent;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, connection.connect(this._userAgent, auth, waitReAuth || false)];
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, connection.connect(this._userAgent, authToken)];
