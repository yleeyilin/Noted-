...
export declare const addCallbackAndSetParamCypher: (field: PrimitiveField, variable: Cypher.Variable, parent: any, callbackBucket: CallbackBucket, operation: "CREATE" | "UPDATE", node: Cypher.Node) => [Cypher.Property, Cypher.RawCypher] | [];
