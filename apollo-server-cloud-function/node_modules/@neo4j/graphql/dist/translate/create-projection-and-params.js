...
function createProjectionAndParams({ resolveTree, node, context, varName, literalElements, resolveType, cypherFieldAliasMap, }) {
        ...
        if (authableField) {
            ...
            if (authorizationPredicateReturn) {
                ...
                if (preComputedSubqueries && !preComputedSubqueries.empty) {
                    ...
                    res.meta.authorizationSubqueries = cypher_builder_1.default.concat(res.meta.authorizationSubqueries, preComputedSubqueries);
                }
            }
    ...
    const { params, meta, subqueriesBeforeSort, subqueries, predicates, projection } = Object.values(mergedFields).reduce(reducer, {
