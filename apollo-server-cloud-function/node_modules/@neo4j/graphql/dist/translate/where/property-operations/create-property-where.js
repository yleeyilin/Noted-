...
function createPropertyWhere({ key, value, element, targetElement, context, useExistExpr = true, }) {
    ...
    const comparisonOp = (0, create_comparison_operation_1.createComparisonOperation)({
        ...
        param: value instanceof cypher_builder_1.default.Param || value instanceof cypher_builder_1.default.Property || value instanceof cypher_builder_1.default.Function
            ? value
