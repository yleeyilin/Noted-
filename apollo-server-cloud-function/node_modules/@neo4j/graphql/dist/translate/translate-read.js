...
function translateRead({ node, context, isRootConnectionField, }, varName = "this") {
    ...
    if (projection.meta?.authValidatePredicates?.length) {
        predicates.push(cypher_builder_1.default.apoc.util.validatePredicate(cypher_builder_1.default.not(cypher_builder_1.default.and(...projection.meta.authValidatePredicates)), constants_1.AUTH_FORBIDDEN_ERROR));
    }
