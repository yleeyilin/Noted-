...
function createProjectionSubquery({ parentNode, whereInput, node, context, subqueryReturnAlias, nestedProjection, nestedSubqueries, targetNode, relationField, relationshipDirection, optionsInput, authValidatePredicates, authorizationPredicates, authorizationSubqueries, addSkipAndLimit = true, collect = true, }) {
    ...
    if (authorizationSubqueries) {
        preComputedWhereFieldSubqueries = cypher_builder_1.default.concat(preComputedWhereFieldSubqueries, authorizationSubqueries);
    }
    // TODO: Authorization - delete for 4.0.0
