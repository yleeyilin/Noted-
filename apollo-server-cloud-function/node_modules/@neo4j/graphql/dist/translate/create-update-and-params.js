        ...
        if (authableField) {
            ...
            if (authorizationBeforeAndParams) {
                ...
                if (authableField.auth) {
                    const { cypher: preAuthCypher, params: preAuthParams } = (0, create_auth_and_params_1.createAuthAndParams)({
            ...
            if (authorizationAfterAndParams) {
                ...
                // TODO: Authorization - delete for 4.0.0
                if (authableField.auth) {
                    const { cypher: postAuthCypher, params: postAuthParams } = (0, create_auth_and_params_1.createAuthAndParams)({
                        entity: authableField,
                        operations: "UPDATE",
                        skipRoles: true,
