...
function createEdgeSubquery({ resolveTree, field, context, parentNode, relatedNode, returnVariable, whereInput, resolveType = false, ignoreSort = false, cypherFieldAliasMap, }) {
    ...
    if (authorizationPredicateReturn) {
        ...
        const authAllowPredicate = (0, create_auth_predicates_1.createAuthPredicates)({
            operations: "READ",
            entity: relatedNode,
            context,
            allow: {
        ...
        if (authAllowPredicate)
            predicates.push(cypher_builder_1.default.apoc.util.validatePredicate(cypher_builder_1.default.not(authAllowPredicate), constants_1.AUTH_FORBIDDEN_ERROR));
    }
