...
function translateTopLevelCypher({ context, info, field, args, type, statement, }) {
    ...
    let params = {
        ...args,
        auth: (0, create_auth_param_1.default)({ context }),
    ...
    if (referenceNode) {
        const { projection: str, params: p, meta, subqueries, subqueriesBeforeSort, predicates, } = (0, create_projection_and_params_1.default)({
            resolveTree,
            node: referenceNode,
            context,
        ...
        referencedNodes.forEach((node) => {
            if (node) {
                ...
                if (!resolveTree.fieldsByTypeName[node.name]) {
                    ...
                    const { projection: str, params: p, meta, subqueries, predicates, } = (0, create_projection_and_params_1.default)({
                        resolveTree,
                        node,
                        context,
                        varName: new cypher_builder_1.default.NamedNode("this"),
