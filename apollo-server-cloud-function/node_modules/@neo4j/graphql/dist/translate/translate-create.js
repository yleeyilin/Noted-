    ...
    if (nodeProjection) {
        const projectionFromInput = varNameVariables.map((varName) => {
            ...
            if (projection.meta?.authValidatePredicates?.length) {
                authPredicates.push(cypher_builder_1.default.apoc.util.validatePredicate(cypher_builder_1.default.not(cypher_builder_1.default.and(...projection.meta.authValidatePredicates)), constants_1.AUTH_FORBIDDEN_ERROR));
            }
