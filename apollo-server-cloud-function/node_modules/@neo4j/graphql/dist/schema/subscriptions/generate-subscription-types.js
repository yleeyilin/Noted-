...
function generateSubscriptionTypes({ schemaComposer, nodes, relationshipFields, interfaceCommonFields, globalSchemaConfiguration, }) {
...
function hydrateSchemaWithSubscriptionWhereTypes(nodesWithSubscriptionOperation, schemaComposer) {
    nodesWithSubscriptionOperation.forEach((node) => (0, generate_subscription_where_type_1.generateSubscriptionWhereType)(node, schemaComposer));
}
