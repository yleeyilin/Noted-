...
const fulltext_2 = require("../resolvers/query/fulltext");
exports.fulltextArgDeprecationMessage = "This argument has been deprecated and will be removed in future versions of the library. " +
...
function augmentFulltextSchema(node, composer, nodeWhereTypeName, nodeSortTypeName) {
    if (node.fulltextDirective) {
        ...
        composer.createInputTC({
            ...
            fields: {
                [fulltext_1.SCORE_FIELD]: "SortDirection",
        ...
        node.fulltextDirective.indexes.forEach((index) => {
            ...
            composer.Query.addFields({
                [queryName]: (0, fulltext_2.fulltextResolver)({ node }, index),
            });
        });
    }
}
