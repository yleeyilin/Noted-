...
function generateSubscribeMethod({ node, type, nodes, relationshipFields, }) {
    return (_root, args, context, resolveInfo) => {
        (0, check_authentication_selection_set_1.checkAuthenticationOnSelectionSet)(resolveInfo, node, type, context);
        ...
        (0, check_authentication_1.checkAuthentication)({ authenticated: concreteEntity, operation: "SUBSCRIBE", context });
        ...
        if (["create", "update", "delete"].includes(type)) {
            return (0, filter_async_iterator_1.filterAsyncIterator)(iterable, (data) => {
                return (data[0].typename === node.name &&
                    (0, authorization_1.subscriptionAuthorization)({ event: data[0], node, entity: concreteEntity, context }) &&
